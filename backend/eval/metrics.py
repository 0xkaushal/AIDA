...
Three metrics:
  ...
  - ContextRecall     : did retrieval surface the information needed to answer?
...
Usage:
    ...
    faithfulness_metric, relevancy_metric, recall_metric = get_metrics()
"""

import sys
from pathlib import Path

# Make backend/app/ importable (mirrors conftest.py approach)
...
from ragas.metrics import (  # noqa: E402  (underscore = stable Metric subclasses)
    _Faithfulness,
    _LLMContextRecall,
    _ResponseRelevancy,
)
